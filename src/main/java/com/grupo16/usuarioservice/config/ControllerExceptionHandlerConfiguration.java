package com.grupo16.usuarioservice.config;
...
import com.grupo16.usuarioservice.exception.ExceptionJson;
...
public class ControllerExceptionHandlerConfiguration {
	...
	@ResponseBody
	public ResponseEntity<ExceptionJson> badCredentialsException(final Throwable e) {
		final ExceptionJson exceptionJson = new ExceptionJson("usuario.credenciaisInvalida", "Usuário ou senha inválido");
		return new ResponseEntity<>(exceptionJson, new HttpHeaders(), HttpStatus.UNAUTHORIZED.value());
	}
