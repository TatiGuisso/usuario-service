...
public class ControllerExceptionHandlerConfiguration {
	...
	private static final String AUTH_EXCEPTION_HANDLER_ERROR_TO_RESOLVE_EXCEPTION = "usuario.exceptionHandler.errorToResolveException";
	private static final String AUTH_ARGUMENT_NOT_VALID = "usuario.argumentNotValid";
